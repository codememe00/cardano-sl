...
some kind of search. Consider this example with three pending transactions
$t_1, t_2$ and $t_3$, and three expected transactions $t_4, t_5, t_6$:
%
\begin{center}
\begin{forest}
[,phantom
  [$(t_1: -1)$] {\draw () to (t4);}
  [$(t_2: -3)$ [$(t_4: +2)$, name=t4] [$(t_5: +1)$, name=t5]]
  [$(t_3: -1)$ [$(t_6: +1)$]] {\draw () to (t5);}
]
\end{forest}
\end{center}
%
Suppose we consider $t_4, t_5, t_6$ in order. We first consider if we
should include $t_4$. Since $\Delta_{\{t_1, t_4\}} > 0$, 


\hrule

Consider this example with pending
