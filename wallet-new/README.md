...
Please note that the latest specification should be stored in [`wallet-new/spec`](https://github.com/input-output-hk/cardano-sl/tree/develop/wallet-new/spec)
directory. So if you made any changes in API - please update `/wallet-new/spec/swagger.json`
as well.
